...
! function(t) {
	...
	o.prototype = {
		...
		getStars : function() {
			for (var t = this, e = t.stars, a = "", n = 1; e >= n; n++)
				a += t.symbol;
			return a;
		},
		...
		getValueFromPosition : function(t) {
			...
			return e = t / l, a = n.rtl ? n.min + Math.floor(n.diff * e / n.step) * n.step : n.min + Math.ceil(n.diff * e / n.step) * n.step, a < n.min ? a = n.min : a > n.max && ( a = n.max), a = s(parseFloat(a), r), n.rtl && ( a = n.max - a), a;
		},
		setStars : function(t) {
		...
		clearElement : null,
		containerClass : null
	}, t("input.rating").addClass("rating-loading"), t(document).ready(function() {
